...
//  static const String baseUrl = 'http://8.210.35.83:8080/';
...
//      print(e);
  ...
  //登陆login
  Future<dynamic> resetPassword(String phoneNum,String code,String password) async {
    Response response;
    try {
  ...
  Future<dynamic> register(String phone_num,String user_name,String passwd,String parent_code,String code) async {
    Response response;
    try {
      return await dio.post('users/register/phone',data: {
        'phone_num':phone_num,
        'user_name':user_name,
        'passwd':passwd,
