...
import 'package:crypto_template/screen/AnotherTemplate/Template1/model_data/Eth_dataModel.dart';
import 'package:flutter/material.dart';

class T1_eth extends StatefulWidget {
  @override
  _T1_ethState createState() => _T1_ethState();
}

class _T1_ethState extends State<T1_eth> {
  @override
  ...
  ///
  Widget _cardHeader(EthDataModel item) {
    return Stack(
      children: <Widget>[
        Container(
          height: 220.0,
