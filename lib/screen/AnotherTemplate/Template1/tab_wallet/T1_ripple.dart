...
import 'package:crypto_template/screen/AnotherTemplate/Template1/model_data/Ripple_dataModel.dart';
import 'package:flutter/material.dart';

class T1_ripple extends StatefulWidget {
  @override
  _T1_rippleState createState() => _T1_rippleState();
}

class _T1_rippleState extends State<T1_ripple> {
  @override
                ...
                return Builder(
                  builder: (BuildContext context) {
                    return Padding(
                      ...
                      child: _cardHeader(listripple[i]),
                    );
                  },
                );
              }).toList(),
  ...
  ///
  Widget _cardHeader(rippleDataModel item) {
    return Stack(
      children: <Widget>[
        Container(
          height: 220.0,
